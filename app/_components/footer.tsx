...
const Footer = () => {
    return (
        ...
        <footer className="w-full flex flex-col justify-between md:flex-row bg-secondary py-6 px-5 lg:px-32">
            <div className="flex flex-col gap-5 items-center md:items-start justify-center md:justify-start pb-5 mt-5 border-b border-gray-500 md:border-none">
                <Link href="/" className="flex gap-1 p-2 rounded-md bg-card font-bold outline-none">
            ...
            <div className="flex flex-col justify-between lg:flex-row pt-5 px-5 lg:px-0 gap-5">
                <div className="flex flex-col">
                    <h3 className="pl-5">DEPARTAMENTOS</h3>
                ...
                <div className="flex flex-col">
                    <h3 className="pl-5">INSTITUCIONAL</h3>
                    <div className="flex items-center gap-1 group">
                        <Scissors className="size-4 opacity-0 group-hover:opacity-100 duration-200" />
